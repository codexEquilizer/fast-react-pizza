    ...
    <div>
      ...
      <Form method="POST">
        <div>
          ...
          <input type="text" name="customer" required className="tw-input" />
          {formErrors?.name && (
        ...
        <div>
          ...
          <div>
            <input type="tel" name="phone" required className="tw-input" />
          </div>
          {formErrors?.phone && (
        ...
        <div>
          <label>Address</label>
          <div>
            <input type="text" name="address" required className="tw-input" />
          </div>
        </div>
